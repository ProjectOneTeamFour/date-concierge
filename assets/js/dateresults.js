    ...
    var cardEl = $("<div>")
        ...
        .html(`
            <div class="card-panel">
                ...
                <p> ${weatherDescription}, with a chance of romance.</p>
...
var generateMapCard = function(restLat, restLng) { 
    ...
    var cardEl = $("<div>")
        ...
        .html(`
            ...
            !5m2!1sen!2sca" width="100%" height=120% frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        `);
